...
$TERMINAL -e /bin/bash -c "cd \"$SCRIPT_DIR\" ; echo -e \"\e]0;Chess standard output\a\e[7m Chess standard output \e[0m\" ; ./autoplay.sh | /opt/luci/ld-luci.so -s -u ai.o board.o game.o openings.o tui.o -lc $* 2>\"$ERR_PIPE\" ; sleep 5" &
