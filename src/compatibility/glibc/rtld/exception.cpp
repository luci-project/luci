...
EXPORT void _dl_exception_create(struct dl_exception *exception, const char *objname, const char *errstring) {
	(void) exception;
	(void) objname;
	(void) errstring;
...
EXPORT void _dl_exception_create_format (struct dl_exception *exception, const char *objname, const char *fmt, ...) {
	(void) exception;
	(void) objname;
	(void) fmt;
...
EXPORT void _dl_exception_free(struct dl_exception *exception) {
	(void) exception;
...
EXPORT int _dl_catch_exception (struct dl_exception *exception, void (*operate) (void *), void *args) {
	(void) exception;
	(void) operate;
	(void) args;
