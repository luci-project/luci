...
#if GLIBC_VERSION >= GLIBC_2_32 || defined(COMPATIBILITY_RHEL_8_LIKE)
...
#if  GLIBC_VERSION >= GLIBC_2_35 || defined(COMPATIBILITY_RHEL_8_LIKE) || defined(COMPATIBILITY_RHEL_9_LIKE)
	__rtld_lock_t _dl_load_tls_lock;
#endif
	uint64_t _dl_load_adds = 0;
	GLIBC::DL::link_map *_dl_initfirst = nullptr;
#if (GLIBC_VERSION < GLIBC_2_30 || defined(COMPATIBILITY_DEBIAN_BUSTER)) && !defined(COMPATIBILITY_RHEL_8_LIKE)
...
#endif
#if GLIBC_VERSION >= GLIBC_2_32 || defined(COMPATIBILITY_DEBIAN_BULLSEYE) || defined(COMPATIBILITY_RHEL_8_LIKE) || defined(COMPATIBILITY_OPENSUSELEAP_15)
...
struct GlobalRO {
...
#if (GLIBC_VERSION >= GLIBC_2_29 && !defined(COMPATIBILITY_DEBIAN_BUSTER)) || defined(COMPATIBILITY_RHEL_8_LIKE)
  ...
  #elif GLIBC_VERSION == GLIBC_2_33 || defined(COMPATIBILITY_RHEL_8_LIKE)
...
#endif
#if GLIBC_VERSION >= GLIBC_2_33 || defined(COMPATIBILITY_RHEL_8_LIKE)
 ...
 #if !defined(COMPATIBILITY_RHEL_8_LIKE)
...
#endif
#if GLIBC_VERSION >= GLIBC_2_34 || defined(COMPATIBILITY_DEBIAN_BULLSEYE) || defined(COMPATIBILITY_RHEL_8_LIKE) || defined(COMPATIBILITY_OPENSUSELEAP_15)
