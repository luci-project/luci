...
#define GLIBC_CPU_HWCAPS \
	TUNABLE_VALUE(glibc, cpu, hwcaps, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_DATA_CACHE_SIZE \
	TUNABLE_VALUE(glibc, cpu, x86_data_cache_size, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_IBT \
	TUNABLE_VALUE(glibc, cpu, x86_ibt, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_NON_TEMPORAL_THRESHOLD \
	TUNABLE_VALUE(glibc, cpu, x86_non_temporal_threshold, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_REP_MOVSB_THRESHOLD \
	TUNABLE_VALUE(glibc, cpu, x86_rep_movsb_threshold, TUNABLE_TYPE_SIZE_T, 1, SIZE_MAX, {2048}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_REP_STOSB_THRESHOLD \
	TUNABLE_VALUE(glibc, cpu, x86_rep_stosb_threshold, TUNABLE_TYPE_SIZE_T, 1, SIZE_MAX, {2048}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_SHARED_CACHE_SIZE \
	TUNABLE_VALUE(glibc, cpu, x86_shared_cache_size, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_CPU_X86_SHSTK \
	TUNABLE_VALUE(glibc, cpu, x86_shstk, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_ENABLE \
	TUNABLE_VALUE(glibc, elision, enable, TUNABLE_TYPE_INT_32, 0, 1, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_SKIP_LOCK_AFTER_RETRIES \
	TUNABLE_VALUE(glibc, elision, skip_lock_after_retries, TUNABLE_TYPE_INT_32, INT32_MIN, INT32_MAX, {3}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_SKIP_LOCK_BUSY \
	TUNABLE_VALUE(glibc, elision, skip_lock_busy, TUNABLE_TYPE_INT_32, INT32_MIN, INT32_MAX, {3}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_SKIP_LOCK_INTERNAL_ABORT \
	TUNABLE_VALUE(glibc, elision, skip_lock_internal_abort, TUNABLE_TYPE_INT_32, INT32_MIN, INT32_MAX, {3}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_SKIP_TRYLOCK_INTERNAL_ABORT \
	TUNABLE_VALUE(glibc, elision, skip_trylock_internal_abort, TUNABLE_TYPE_INT_32, INT32_MIN, INT32_MAX, {3}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_ELISION_TRIES \
	TUNABLE_VALUE(glibc, elision, tries, TUNABLE_TYPE_INT_32, INT32_MIN, INT32_MAX, {3}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_GMON_MINARCS \
	TUNABLE_VALUE(glibc, gmon, minarcs, TUNABLE_TYPE_INT_32, 0x32, INT32_MAX, {0x32}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_GMON_MAXARCS \
	TUNABLE_VALUE(glibc, gmon, maxarcs, TUNABLE_TYPE_INT_32, 0x32, INT32_MAX, {0x100000}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)
...
#define GLIBC_MALLOC_HUGETLB \
	TUNABLE_VALUE(glibc, malloc, hugetlb, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)
...
#define GLIBC_MALLOC_MXFAST \
	TUNABLE_VALUE(glibc, malloc, mxfast, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_IGNORE, nullptr)
...
#define GLIBC_MALLOC_TCACHE_COUNT \
	TUNABLE_VALUE(glibc, malloc, tcache_count, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_MALLOC_TCACHE_MAX \
	TUNABLE_VALUE(glibc, malloc, tcache_max, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_MALLOC_TCACHE_UNSORTED_LIMIT \
	TUNABLE_VALUE(glibc, malloc, tcache_unsorted_limit, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)
...
#define GLIBC_MEM_TAGGING \
	TUNABLE_VALUE(glibc, mem, tagging, TUNABLE_TYPE_INT_32, 0, 255, {0}, false, TUNABLE_SECLEVEL_SXID_IGNORE, nullptr)

#define GLIBC_PTHREAD_MUTEX_SPIN_COUNT \
	TUNABLE_VALUE(glibc, pthread, mutex_spin_count, TUNABLE_TYPE_INT_32, 0, 32767, {100}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_PTHREAD_RSEQ \
	TUNABLE_VALUE(glibc, pthread, rseq, TUNABLE_TYPE_INT_32, 0, 1, {1}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_PTHREAD_STACK_CACHE_SIZE \
	TUNABLE_VALUE(glibc, pthread, stack_cache_size, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {41943040}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_PTHREAD_STACK_HUGETLB \
	TUNABLE_VALUE(glibc, pthread, stack_hugetlb, TUNABLE_TYPE_INT_32, 0, 1, {1}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_RTLD_DYNAMIC_SORT \
	TUNABLE_VALUE(glibc, rtld, dynamic_sort, TUNABLE_TYPE_INT_32, 1, 2, {2}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_RTLD_NNS \
	TUNABLE_VALUE(glibc, rtld, nns, TUNABLE_TYPE_SIZE_T, 1, 16, {4}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_RTLD_OPTIONAL_STATIC_TLS \
	TUNABLE_VALUE(glibc, rtld, optional_static_tls, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {512}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)
...
#define GLIBC_TUNE_HWCAPS \
	TUNABLE_VALUE(glibc, tune, hwcaps, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_TUNE_X86_DATA_CACHE_SIZE \
	TUNABLE_VALUE(glibc, tune, x86_data_cache_size, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_TUNE_X86_IBT \
	TUNABLE_VALUE(glibc, tune, x86_ibt, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_TUNE_X86_NON_TEMPORAL_THRESHOLD  \
	TUNABLE_VALUE(glibc, tune, x86_non_temporal_threshold, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_TUNE_X86_SHARED_CACHE_SIZE \
	TUNABLE_VALUE(glibc, tune, x86_shared_cache_size, TUNABLE_TYPE_SIZE_T, 0, SIZE_MAX, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)

#define GLIBC_TUNE_X86_SHSTK \
	TUNABLE_VALUE(glibc, tune, x86_shstk, TUNABLE_TYPE_STRING, 0, 0, {0}, false, TUNABLE_SECLEVEL_SXID_ERASE, nullptr)
